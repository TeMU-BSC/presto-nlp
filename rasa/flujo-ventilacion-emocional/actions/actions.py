...
class Distortion(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        intents_list = ["sobregeneralizacion", "etiquetado", "deberias", "lectordementes", "pensamientoabsolutista", "adivinacion", "catastrofismo"]
...
class PsicoEdu(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        my_events_list = create_my_events_list(self, tracker.events)
        distortions_list = ["sobregeneralizacion", "etiquetado", "deberias", "lectordementes", "pensamientoabsolutista", "adivinacion", "catastrofismo"]
        ...
        distortions_dict = {"sobregeneralizacion": ["utter_psico_edu_sobre", "utter_selector_psico_edu_sobre"],  
                            ...
                            "lectordementes": ["utter_psico_edu_lectordementes", "utter_selector_psico_edu_lectordementes"], 
                            "pensamientoabsolutista": ["utter_psico_edu_pensamientoabsolutista", "utter_selector_psico_edu_pensamientoabsolutista"], 
                            "adivinacion": ["utter_psico_edu_adivinacion", "utter_selector_psico_edu_adivinacion"], 
                            "catastrofismo": ["utter_psico_edu_catastrofismo", "utter_selector_psico_edu_catastrofismo"]}
