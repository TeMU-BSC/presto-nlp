...
```
python agreement.py --level distortion --an-ids xavi mireia --an-file presto_distortion.jsonl

python agreement.py --level types --metrics single_cohen multi_cohen exact_cohen --an-ids xavi mireia --an-file types_de_los_coincidentes.jsonl --pre_annotations
```